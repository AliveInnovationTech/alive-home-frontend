import BrandLogoHalf from "@/public/assets/brandlogo-half.svg";
import Image from "next/image";

export default function RightContainer() {
  return (
    <div className="bg-gradient-to-br w-full h-screen hidden md:w-1/2 sticky top-0  md:flex gap-28 flex-col pt-28 items-center from-[#C77D01] via-[#C77D01] to-[#C77D01] ">
